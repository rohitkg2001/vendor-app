            ...
            <Modal visible={isCameraOpen} animationType="slide" onRequestClose={() => setIsCameraOpen(false)}>
                <View style={styles.cameraContainer}>
                    ...
                    <View style={styles.controls}>
                        <TouchableOpacity onPress={() => setScanned(false)} style={styles.retakeButton}>
                            <Icon name="refresh" size={35} color="white" accessibilityLabel='Retake' />
                        </TouchableOpacity>

                        <TouchableOpacity onPress={() => console.log("Capture Button Pressed")} style={styles.shutterButton}>
