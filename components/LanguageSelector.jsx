...
import { typography, SCREEN_WIDTH, spacing, PRIMARY_COLOR, styles, ICON_SMALL } from "../styles";
...
export default function LanguageSelector({ onSelectLanguage }) {
  return (
    <MyImageBackground imageSource={ImageSource}>
      ...
      <Span style={[typography.font16, spacing.mt5, spacing.mh2]}>Please select your preferred language:</Span>
      <Button
        style={[styles.btn, styles.bgPrimary, spacing.m1, spacing.br5, { width: SCREEN_WIDTH - 16, justifyContent: 'center' },]}
        onPress={() => onSelectLanguage("en")}
      >
        <H2 style={[styles.btnText, typography.font20, typography.textLight]}>English</H2>
      </Button>
      <Button
        style={[styles.btn, styles.bgLight, spacing.m1, spacing.bw2, spacing.br5, { width: SCREEN_WIDTH - 16, justifyContent: 'center', borderColor: PRIMARY_COLOR }]}
        onPress={() => onSelectLanguage("hi")}
      >
        <H2 style={[styles.btnText, typography.font20, typography.textPrimary]}>हिंदी</H2>
      </Button>
    </MyImageBackground>
  );
};
